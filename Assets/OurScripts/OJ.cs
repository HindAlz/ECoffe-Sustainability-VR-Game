...
{
    [Header("Orange Juice Recipe")]
    [SerializeField] private string recipeName = "Orange Juice";
    [SerializeField] private List<string> ingredients = new List<string> { "Orange Juice", "Ice" };
